                        ...
                        <CardItem onPress={ () => { this.goToServices() }}>
                            <View transparent style={{ padding : 10 , margin : 10 }}>
                                ...
                                <Text style={{ textAlign : 'justify' }}>
                                    ...
                                    We know that for your customers, it needs to be a satisfying, enjoyable experience
                                    where people find what they’re looking for and accomplish their goals. That’s why we
                                    also provide user-experience (UX) design. It’s where thinking meets technology to
                                    make user-friendly a reality.
                                    In other words, a website that’s intuitive to use, pleasing to look at, and is built
                                    with rich content that invites exploration.
                                </Text>
                            </View>
                        </CardItem>
                        <CardItem onPress={ () => { this.goToServices() }}>
                            <View transparent style={{ padding : 10 , margin : 10 }}>
                                ...
                                <Hr lineColor='#b3b3b3' text=' ::: ' textColor='steelblue'/>
                                <Text style={{ textAlign : 'justify' }}>
                                    Mobile App Design and mobile app development are essential components to almost
                                    every single business today.
                                    From employees to customers, mobile apps make it possible for people to stay
                                    constantly connected and productive.
                                    We’re committed to understanding how customers interact with your business online,
                                    and taking this understanding to the next level to tailor your project to reach and
                                    engage them most effectively.
                                    We give you good reason to be confident that your mobile app development is in safe
                                    hands. We are proactive in our approach and we’re enthusiastically invested in our
                                    clients’ projects which drives us to meet your deadlines in a timely manner.
                                </Text>
                            </View>
                        </CardItem>
                    </Card>
